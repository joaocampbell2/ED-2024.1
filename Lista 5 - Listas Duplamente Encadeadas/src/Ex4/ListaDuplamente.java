...
//complexidade 0(n) existem dois loops, mas nao sao aninhado
	public boolean trocaElos(int indiceElo1, int indiceElo2){
	int index = 0;
	int dado1 = Integer.MIN_VALUE;
	int dado2 = Integer.MIN_VALUE;
	for(Elo p = prim; p != null;p = p.prox, index++){
		if (index == indiceElo1){
			dado1 = p.dado;
		}
		if (index == indiceElo2){
