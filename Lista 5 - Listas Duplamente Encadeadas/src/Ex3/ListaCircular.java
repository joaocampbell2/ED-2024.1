...
public class ListaCircular extends Ex3.Lista
{
	...
	public ListaCircular inverteLista(){
		...
		for(int i = 0; i< this.tamanho(); i++){
			Elo p1;
			for(p1 = p;p1.prox != p;p1 = p1.prox){
			}
			listaInvertida.insere(p1.dado);
			p = p1;
